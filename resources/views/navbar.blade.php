    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Eighth navbar example">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample07">
                ...
                <form>
                    <input onkeyup="searchTitulo(this)" class="form-control border-radius" type="text" placeholder="Título da pesquisa" aria-label="Search">
                </form>
            </div>
        </div>
    </nav>
               ...
               data.forEach(function (item) {
                   html += `<div class="col-md-4 col-12">
                               <div class="card mb-2 text-center " style="width: 100%;">
                                   <div class="card-body">
                                       <h5 class="card-title overflow-hidden" style="height:75px;"><b>` + item.titulo + `</b></h5>
                                       <p class="card-text overflow-hidden" style="height: 100px;">` + item.descricao + `</p>
